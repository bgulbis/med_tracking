...
WHERE
	CLINICAL_EVENT.EVENT_CD IN (
	    ...
	    117038716,
	    37557342,
	    37557233, 37557232, 609787708, 259555491,
	    37557425,
	    2737463843,
	    37557675,
	    37557776,
	...
	AND (
		...
		AND (CE_MED_RESULT.ADMIN_DOSAGE > 0 OR CE_MED_RESULT.IV_EVENT_CD = 688706)
	)
	AND (
	    CLINICAL_EVENT.EVENT_CD NOT IN (37556009, 37557425)
	    OR CE_MED_RESULT.ADMIN_ROUTE_CD IN (508984, 9022513, 9022647, 9022649)
	)
	AND (
