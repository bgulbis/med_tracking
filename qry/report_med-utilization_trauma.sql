WITH DOSES AS (
	SELECT DISTINCT
		...
		pi_from_gmt(CLINICAL_EVENT.EVENT_END_DT_TM, 'CST') AS DOSE_DATETIME,
		TRUNC(pi_from_gmt(CLINICAL_EVENT.EVENT_END_DT_TM, 'CST'), 'MONTH') AS DOSE_MONTH,
	...
	WHERE
		...
		AND CLINICAL_EVENT.EVENT_END_DT_TM BETWEEN
			pi_to_gmt(ADD_MONTHS(TRUNC(ADD_MONTHS(SYSDATE, 6), 'YEAR'), -18), 'CST')
