SELECT DISTINCT
	TO_CHAR(TRUNC(pi_from_gmt(CLINICAL_EVENT.EVENT_END_DT_TM, (pi_time_zone(1, @Variable('BOUSER'))))), 'YYYY-MM-DD') AS DS,
	COUNT(CLINICAL_EVENT.EVENT_ID) AS Y
FROM
	CE_MED_RESULT,
	CLINICAL_EVENT,
	ENCNTR_LOC_HIST,
	ENCOUNTER
WHERE
	CLINICAL_EVENT.EVENT_CD = 37556009
	...
	AND (
		...
		AND CE_MED_RESULT.ADMIN_ROUTE_CD IN (508984, 9022513, 9022647)
	)
	AND (
