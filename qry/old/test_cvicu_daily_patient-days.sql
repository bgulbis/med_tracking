WITH UNIT_ENCNTR_LIST AS (
	...
	WHERE
		...
		AND ENCNTR_LOC_HIST.TRANSACTION_DT_TM 
			BETWEEN pi_to_gmt(TRUNC(ADD_MONTHS(SYSDATE, -1), 'MONTH'), pi_time_zone(2, @Variable('BOUSER')))
	...
	WHERE
		...
		AND UNIT_TRNSFRS.TRANSFER_DATE BETWEEN TRUNC(ADD_MONTHS(SYSDATE, -1), 'MONTH') AND TRUNC(SYSDATE, 'MONTH') - (1 / 86400)
	GROUP BY
		UNIT_TRNSFRS.TRANSFER_DATE
), CENSUS AS (
	SELECT DISTINCT
