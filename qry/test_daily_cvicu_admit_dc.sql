SELECT DISTINCT
	ENCNTR_LOC_HIST.ENCNTR_ID AS ENCOUNTER_ID,
	...
	pi_from_gmt(ENCNTR_LOC_HIST.BEG_EFFECTIVE_DT_TM, (pi_time_zone(1, @Variable('BOUSER')))) AS BEGIN_DATETIME,
	pi_from_gmt(ENCNTR_LOC_HIST.END_EFFECTIVE_DT_TM, (pi_time_zone(1, @Variable('BOUSER')))) AS END_DATETIME,
	CV_NURSE_UNIT.DISPLAY AS NURSE_UNIT,
	pi_from_gmt(LEAD(ENCNTR_LOC_HIST.BEG_EFFECTIVE_DT_TM, 1) OVER (PARTITION BY ENCNTR_LOC_HIST.ENCNTR_ID ORDER BY ENCNTR_LOC_HIST.ENCNTR_LOC_HIST_ID), (pi_time_zone(1, @Variable('BOUSER')))) AS NEXT_BEGIN_DATETIME
FROM
